...
public class CircuLationRecord implements Serializable {
	...
	public CircuLationRecord(String fallbackname, int state, String createDate, String username, String parentnodeId,
	...
	public CircuLationRecord(String fallbackname, int state, String createDate, String username, String parentnodeId,
			String city, String rolename, int id) {
		super();
		this.fallbackname = fallbackname;
		this.state = state;
		this.createDate = createDate;
	...
	public CircuLationRecord(String fallbackname, int state, String createDate, String username, String parentnodeId,
			String city, String rolename, String spare1, int id) {
		super();
		this.fallbackname = fallbackname;
		this.state = state;
		this.createDate = createDate;
