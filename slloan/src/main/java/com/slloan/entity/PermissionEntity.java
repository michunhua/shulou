...
public class PermissionEntity implements Serializable{
	...
	private Integer id;
	private String checkboxID;//传过来复选框的ID
	private String r_id;//权限ID
	private String url;
	...
	public PermissionEntity(String checkboxID, String r_id) {
		this.checkboxID = checkboxID;
		this.r_id = r_id;
	}
	public PermissionEntity(Integer id, String checkboxID, String r_id,String url) {
		this.id = id;
		this.checkboxID = checkboxID;
		this.r_id = r_id;
		this.url = url;
	...
	public String toString() {
		return "PermissionEntity [id=" + id + ", checkboxID=" + checkboxID + ", r_id=" + r_id + ", url=" + url + "]";
	}
...
//	private String orderline;//排序值
	...
	public PermissionEntity(String loan_management, String repayment_confirmation, String loan_Final_review,
			...
			String parent_id, String url, String method) {
		super();
...
//		this.county = county;
	...
	@Override
	public String toString() {
		return "PermissionEntity [loan_management=" + loan_management + ", repayment_confirmation=" + repayment_confirmation
				...
				+ modify_user + ", parent_id=" + parent_id + ", url=" + url + ", method=" + method + ", city=" + city
				+ ", county=" + county + "]";
	}
