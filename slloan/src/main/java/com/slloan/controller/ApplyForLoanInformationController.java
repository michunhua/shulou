...
public class ApplyForLoanInformationController {
	...
	public Json save(HttpServletRequest req) {
		...
		String username = obj.getString("username");
		 String parentnodeId = obj.getString("id");
...
//		 String city ="北京";
//		String rolename = "按揭员";
		ApplyForLoanInformation ap = new ApplyForLoanInformation(amount, time_Limit,time_Limits, borrowing_Variety, repayment,
	...
	public String updateUser(HttpServletRequest req){
		...
		ApplyForLoanInformation ap = new ApplyForLoanInformation(id,amount, time_Limit,time_Limits, borrowing_Variety, repayment,
				receiving_Bank_Name, receiving_Account_Name, receiving_Account, repayment_Bank_Name,
