...
public class JointApplicantServiceImpl implements JointApplicantService {
	...
	public boolean save(JointApplicant jointApplicant) {
		 ...
		 String name=jointApplicant.getName(); // 共同借款人姓名
				 ...
				 String housing_condition_now=jointApplicant.getHousing_condition_now();  // 0房改/继承 1按揭自置2无按揭自置 3与父母同住 4租借// 5公司提供 6其他
				 ...
				 String start=jointApplicant.getstart();  // 状态  0按揭员录单1待初审审批中2待终审审批中3待出账确认4待放款5待取证6待解押7待进押8待确认回款9待结算10已结清
