...
//    sendAjax(method, url, data, null)
    window.location.href = '../../slloan/loan/financiltranslinkInfo'
  })
}
...
var backlist = function() {
	  ...
	  evs.addEventListener('click', function() {
	    ...
	    log(data)
//	    sendAjax(method, url, data, null)
	    window.location.href = '../../slloan/financial/transfervoucher'
	  })
	}
...
window.onload = function() {
	...
	data.listid = localStorage.transInfo
	if(localStorage.transInfo) {
...
var readImage = function(element, select) {
	...
	intent.addEventListener('click', function(event) {
		if(event.target.classList.contains(select)) {
			...
			data.username = localStorage.purusername
			data.rolename = localStorage.purrole
			data.id = localStorage.transInfo
