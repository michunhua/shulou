...
//    sendAjax(method, url, data, null)
    window.location.href = '../../slloan/loan/repayinfolinkInfo'
  })
}
...
var backlist = function() {
	  ...
	  evs.addEventListener('click', function() {
	    ...
	    log(data)
//	    sendAjax(method, url, data, null)
	    window.location.href = '../../slloan/loan/repa'
	  })
	}
...
window.onload = function() {
	...
	data.listid = localStorage.repayID
	if(localStorage.repayID) {
